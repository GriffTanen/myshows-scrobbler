...
> - **экспериментальный** импорт истории просмотров из Jellyfin в MyShows (фильмы и эпизоды) одним действием — см. [Импорт истории просмотров (экспериментально)](#импорт-истории-просмотров-экспериментально).
>
